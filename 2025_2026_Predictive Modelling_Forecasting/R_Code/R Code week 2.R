...
# Create AR(1) model, using the data from the exercise (Run Exercises.R first!)
x_data <- x1 # Change x1 to x2, or x3 respectively to create the plot for other values of phi
ar_model <- Arima(x_data, c(1, 0, 0))
...
# Using data from the exercise (Run Exercises.R first!)
