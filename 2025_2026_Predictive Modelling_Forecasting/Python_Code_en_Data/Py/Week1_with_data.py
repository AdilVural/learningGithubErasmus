...
# load data
data = pd.read_excel("../data/LA real GDP per capita.xlsx")
...
# UK consumption data ---------------------------------------------------------------------------------------------
household = (pd.read_excel("../data/UK household final consumption.xlsx")
...
rev = (pd.read_excel("../data/AEA revenue passenger kilometres.xlsx")
...
# Nonlinearity ----------------------------------------------------------------------------------------------------
unemp = (pd.read_excel("../data/US unemployment rate.xlsx")
           .query("Name != 'Datastream Code'")
           .rename(columns={
               "Name": "period",
               "US UNEMPLOYMENT RATE (SEASONALLY ADJUSTED)": "unemp_rate_s",
               "US CIVILIAN UNEMPLOYMENT RATE (NOT SEASONALLY ADJUSTED)": "unemp_rate_ns"
           })[["period", "unemp_rate_s", "unemp_rate_ns"]])
